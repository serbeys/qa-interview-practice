...
if(localStorage.stopwatchRunningTime){
    stopwatchDigits.text(returnFormattedToMilliseconds(Number(localStorage.stopwatchRunningTime), true));
    console.log(stopwatchDigits.text());
}
else{
...
function startStopwatch(){
    ...
    stopwatchInterval = setInterval(function () {
        ...
        stopwatchDigits.text(returnFormattedToMilliseconds(stopwatchTime, false));
        console.log(stopwatchDigits.text());
    }, 100);
...
function resetStopwatch(){
    ...
    stopwatchDigits.text(returnFormattedToMilliseconds(0, true));
    localStorage.stopwatchBeginingTimestamp = 0;
    localStorage.stopwatchRunningTime = 0;
...
function returnFormattedToMilliseconds(time, reset){
    var milliseconds = 9 - Math.floor((time % 1000) / 100),
